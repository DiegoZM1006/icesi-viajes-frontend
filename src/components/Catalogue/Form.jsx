...
function Form(props) {
    ...
    return (
        <form className="[box-shadow:rgba(0,_0,_0,_0.16)_0px_3px_6px,_rgba(0,_0,_0,_0.23)_0px_3px_6px] h-full bg-[--var-light] flex gap-6 p-5 rounded-lg" onSubmit={handleAddDestination}>
            <section className="flex flex-col gap-3">
                ...
                <div>
                    ...
                    <textarea value={props.information} type="text" id='more_info' name='more_info' placeholder='Escribe informacion adicional de lo que tenga el destino' className='w-full mt-1 p-2 border border-gray-300 rounded-md' />
                </div> 
            </section>
